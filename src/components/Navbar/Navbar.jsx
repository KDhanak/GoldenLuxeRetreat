...
const Navabar = () => {
    return (
        <>
            <div className="flex items-center justify-between mb-7 font-serif">
                <div className="relative left-20 top-5 logo">
                    <a href="/">
                        <img src={logo} className="block h-24 w-auto" />
                    </a>
                </div>
                <div className="relative top-5 right-28 menu">
                    <ul className="flex space-x-24 p-5 text-base font-medium text-primary_3 list-none">
